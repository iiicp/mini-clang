...
public:
    ...
    virtual void Ident(SourceLocation Loc, const std::string &str) override {
      First->Ident(Loc, str);
    ...
    virtual void MacroExpands(const Token &Id, const MacroInfo *MI) override {
      First->MacroExpands(Id, MI);
      Second->MacroExpands(Id, MI);
    }

    virtual void MacroDefined(const IdentifierInfo *II, const MacroInfo *MI) override {
      First->MacroDefined(II, MI);
      Second->MacroDefined(II, MI);
    }

    virtual void MacroUndefined(const IdentifierInfo *II, const MacroInfo *MI) override {
