...
public:
  ...
  struct DestroyerToUID;
  template<>
  struct DestroyerToUID<&ActionBase::DeleteExpr> {
    static const unsigned UID = 0;
  };
  template<>
  struct DestroyerToUID<&ActionBase::DeleteStmt> {
...
public:
  ...
  inline ASTMultiPtr<Destroyer> move_arg(ASTOwningVector<Destroyer, N> &vec) {
#if !defined(DISABLE_SMART_POINTERS)
  ...
  template<ASTDestroyer Destroyer>
  inline void moving::ASTMultiMover<Destroyer>::release() {
    Moved.Nodes = 0;
    Moved.Count = 0;
  }
  ...
  template<ASTDestroyer Destroyer>
  inline ASTOwningResult<Destroyer> move(ASTOwningResult<Destroyer> &ptr) {
    return ASTOwningResult<Destroyer>(moving::ASTResultMover<Destroyer>(ptr));
  }

  template<ASTDestroyer Destroyer>
  inline ASTMultiPtr<Destroyer> move(ASTMultiPtr<Destroyer> &ptr) {
  ...
  template<ASTDestroyer Destroyer>
  inline ASTOwningPtr<Destroyer>::ASTOwningPtr(const ASTOwningResult<Destroyer> &o)
      : Node(o.get()) {}
  ...
  template<ASTDestroyer Destroyer>
  inline ASTOwningPtr<Destroyer> &move(ASTOwningPtr<Destroyer> &ptr) {
    return ptr;
  }
