...
void Preprocessor::CommitBacktrackedTokens() {
  assert(!BacktrackPositions.empty() && "EnableBacktrackAtThisPos was not called!");
...
//  assert(CachedTokens[CachedLexPos - 1].getLocation() == Tok.getAnnotationEndLoc() && "The annotation should be until the most recent cached token");
//
