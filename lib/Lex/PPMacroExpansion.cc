...
static void ComputeDATE_TIME(SourceLocation &DATELoc, SourceLocation &TIMELoc,
  ...
  char TmpBuffer[100];
  snprintf(TmpBuffer, sizeof(TmpBuffer) - 1, "\"%s %2d %4d\"", Months[TM->tm_mon], TM->tm_mday,
           TM->tm_year + 1900);
...
void Preprocessor::ExpandBuiltinMacro(Token &Tok) {
  ...
  if (II == Ident__LINE__) {
    ...
    snprintf(TmpBuffer, sizeof(TmpBuffer) - 1, "%u", PLoc.getLine());
    ...
    snprintf(TmpBuffer, sizeof(TmpBuffer) - 1, "%u", Depth);
    Tok.setKind(tok::numeric_constant);
    CreateString(TmpBuffer, strlen(TmpBuffer), Tok, Tok.getLocation());
    ...
    snprintf(TmpBuffer, sizeof(TmpBuffer) - 1, "%u", CounterValue++);
    Tok.setKind(tok::numeric_constant);
    CreateString(TmpBuffer, strlen(TmpBuffer), Tok, Tok.getLocation());
    ...
    snprintf(TmpBuffer, sizeof(TmpBuffer) - 1, "%d", (int) Value);
    Tok.setKind(tok::numeric_constant);
    CreateString(TmpBuffer, strlen(TmpBuffer), Tok, Tok.getLocation());
  } else {
