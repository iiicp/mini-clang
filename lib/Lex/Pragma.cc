...
namespace {
  ...
  struct PragmaOnceHandler : public PragmaHandler {
    ...
    virtual void HandlePragma(Preprocessor &PP, Token &OnceTok) override {
  ...
  struct PragmaMarkHandler : public PragmaHandler {
    ...
    virtual void HandlePragma(Preprocessor &PP, Token &MarkTok) override {
      PP.HandlePragmaMark();
    }
  };
  ...
  struct PragmaPoisonHandler : public PragmaHandler {
    ...
    virtual void HandlePragma(Preprocessor &PP, Token &PoisonTok) override {
  ...
  struct PragmaSystemHeaderHandler : public PragmaHandler {
    ...
    virtual void HandlePragma(Preprocessor &PP, Token &SHToken) override {
  ...
  struct PragmaDependencyHandler : public PragmaHandler {
    ...
    virtual void HandlePragma(Preprocessor &PP, Token &DepToken) override {
...
public:
    PragmaDiagnosticHandler(const IdentifierInfo *ID,
                            const bool clangMode) : PragmaHandler(ID),
                                                    ClangMode(clangMode) {}
    virtual void HandlePragma(Preprocessor &PP, Token &DiagToken) override {
      Token Tok;
      PP.LexUnexpandedToken(Tok);
      if (Tok.isNot(tok::identifier)) {
  ...
  struct PragmaCommentHandler : public PragmaHandler {
    ...
    virtual void HandlePragma(Preprocessor &PP, Token &CommentTok) override {
  ...
  struct PragmaSTDC_FP_CONTRACTHandler : public PragmaHandler {
    ...
    virtual void HandlePragma(Preprocessor &PP, Token &Tok) override {
  ...
  struct PragmaSTDC_UnknownHandler : public PragmaHandler {
    ...
    virtual void HandlePragma(Preprocessor &PP, Token &UnknownTok) override {
