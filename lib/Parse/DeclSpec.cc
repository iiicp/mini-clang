...
template<class T>
static bool BadSpecifier(T TNew, T TPrev,
                         const char *&PrevSpec,
                         unsigned &DiagID) {
...
bool DeclSpec::isMissingDeclaratorOk() {
  ...
  return (tst == TST_union || tst == TST_struct || tst == TST_class || tst == TST_enum) && getTypeRep() != 0 && StorageClassSpec != DeclSpec::SCS_typedef;
}
